            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <h4 class="text-center mt-4">Selamat Datang Di Website Puskesmas UA Medika<br />Projek Web 1 - Individu</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mt-3">
                                                        ...
                                                        <div class="text-center pt-5">
                                                            <img src="dist/img/profile.jpg" class="img-fluid" alt="Profile Image">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                        ...
                        <div class="card-footer">
                            Projek 1 - Aplikasi Web Sederhana Puskesmas UA Medika
                        </div>
                        <!-- /.card-footer-->
                    </div>
                    <!-- /.card -->
